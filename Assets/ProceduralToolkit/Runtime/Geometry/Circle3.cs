...
namespace ProceduralToolkit
{
    ...
    public struct Circle3 : IEquatable<Circle3>, IFormattable
    {
        ...
        public static Circle3 unitXY => new(Vector3.zero, Vector3.back, 1);
        public static Circle3 unitXZ => new(Vector3.zero, Vector3.up, 1);
        public static Circle3 unitYZ => new(Vector3.zero, Vector3.left, 1);

        #region IEquatable<Circle3> Members
